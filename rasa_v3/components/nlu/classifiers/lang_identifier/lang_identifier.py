...
class LanguageIdentifier:
    def __init__(
        ...
        self._agent = Agent.load(model_path=self._model_name)
    ...
    async def identify(self, text: Text) -> Optional[Dict]:
        try:
            parsed_ = await self._agent.parse_message(message_data=text)
            return parsed_
...
if __name__ == "__main__":
    ...
    res = asyncio.run(language_identifier.identify(text="hi, how are you?"))
